...
- Type :: list of strings
- Default :: =gdm,gnome-shell,gnome-session,gnome-console,gnome-control-center,nautilus,gnome-text-editor,xdg-user-dirs-gtk,gnome-tweaks,gnome-shell-extension-common=
- Since :: 0.1.0
...
to drive, not an office suite to download.
