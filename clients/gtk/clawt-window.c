...
refresh_settings_folders(ClawtWindow *self)
{
    ...
    if (!refresh_enter(self, CLAWT_REFRESH_SHARED_FOLDERS))
        return;
    ...
    do {
        ...
        clear_list(GTK_LIST_BOX(self->settings_folders));
...
static GtkWidget *
build_shared_folders_page(ClawtWindow *self)
{
    GtkWidget *page = adw_preferences_page_new();
    GtkWidget *group = adw_preferences_group_new();
    GtkWidget *add;
                     ...
                     gpointer user_data)
{
    ...
    adw_preferences_dialog_add(ADW_PREFERENCES_DIALOG(dialog),
                               ADW_PREFERENCES_PAGE(
                                   build_shared_folders_page(self)));
    adw_preferences_dialog_add(ADW_PREFERENCES_DIALOG(dialog),
                               ADW_PREFERENCES_PAGE(
