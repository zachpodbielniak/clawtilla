...
"\n"
"The section above is written from the live list every time you start,\n"
"and it is the whole of what you have. What follows is when to reach for\n"
"which -- not what exists.\n"
"\n"
...
"* Delegating work\n"
"\n"
"~clawtilla_delegate~ hands work over and gives you a task id at once;\n"
"~clawtilla_task_list~ shows everything you delegated, everything\n"
"delegated to you, and what those turned into further down.\n"
"\n"
"A task does *not* get a session of its own. It lands in whichever\n"
"conversation it arrived through and inherits the context already there,\n"
"so a delegation is a message with a receipt attached, not a clean room.\n"
"Say enough in it to stand alone.\n"
"\n"
"** Finishing, and not finishing\n"
"\n"
"If work was delegated *to you*, end it with ~clawtilla_task_complete~\n"
"and its result.\n"
"\n"
"If you are *not* finished -- you handed part of it on, you scheduled a\n"
"wakeup, you are waiting on somebody -- call ~clawtilla_task_progress~\n"
"with a note before your turn ends. Ending a turn is otherwise taken as\n"
"finishing the work, because an AI CLI cannot end one without writing\n"
"something, and the last thing you wrote becomes the result. Doing the\n"
"sensible thing and reporting once at the end used to close the task\n"
"under you, with a status note as its answer.\n"
"\n"
"You do not have to do this for work you handed on with\n"
"~clawtilla_delegate~: a task with children still running will not be\n"
"closed by your turn ending. It is for everything else.\n"
"\n"
"* Your mailbox\n"
"\n"
...
"cannot read theirs.\n"
"\n"
"The memory tools are in the generated section at the top of this file,\n"
"if you have them -- the store can be switched off for an agent, and\n"
"then they are not there to call. What follows is when to reach for\n"
"them, not what you have.\n"
"\n"
...
"syntax is *not* interpreted: ~>~, ~|~, ~&&~, ~;~, ~$(...)~ and ~$VAR~\n"
"would arrive at the command as literal text rather than doing\n"
"anything.\n"
"\n"
"A command line that needs a shell is therefore *refused*, naming the\n"
"construct it found. It used to run anyway -- exit 0, the rest of the\n"
"line echoed back to you, and nothing done -- which reads as a command\n"
"that behaved oddly rather than one that was never a command.\n"
"\n"
...
"#+end_src\n"
"\n"
"Quoting is what separates the two, and it is read before the command is\n"
"split: ~grep \'a|b\' file~ is accepted, because the pipe is quoted and\n"
"you meant it literally. Globs are never refused -- an unquoted ~*.log~\n"
"reaches the program unchanged, which is sometimes the point.\n"
"\n"
